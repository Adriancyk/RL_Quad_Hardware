...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_model_path', default='/home/adrian/RL_ws/src/RL_gazebo_drone/scripts/checkpoints/sac_checkpoint_Quadrotor_episode2200_mode_takeoff', type=str, help='path to trained model (caution: do not use it for model saving)')
